...
class AddEditSpecialCards extends React.Component {
    ...
    handleAddSpecialCard = specialCard => {
        ...
        return addSpecialCard({ name, icon, requirements }, user).then(() => {
    ...
    handleEditSpecialCard = specialCard => {
        ...
        return editSpecialCard({ id, name, icon, requirements }, user).then(
            () => {
    ...
    render() {
        ...
        const requirements =
            selectedCard && mobx.toJS(selectedCard.requirements);
        return (
